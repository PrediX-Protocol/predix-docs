# 8. Hệ Sinh Thái NFT
Chi phí mint trên Unichain L2: ~$0,01–$0,05/NFT. Gamification tăng engagement 47%, loyalty 22% (nghiên cứu Mintology). Không đối thủ prediction market nào có lớp gamification hay NFT.
PrediX xây dựng hệ sinh thái NFT với hai lớp chức năng: Identity/Gamification (tăng retention, tạo danh tính on-chain) và Tài Sản Tài Chính (tokenize vị thế, tạo thị trường thứ cấp).
...
Mô tả: Semi-fungible badges mint tự động khi đạt milestone
Danh sách badges:
...
| NFT | Chuẩn | Chuyển nhượng | Utility chính | Ref |
|---|---|---|---|---|
| Trader Passport | ERC-5192 | Không (Soulbound) | Fee tier, whitelist, eligibility | Galxe, Lens |
| Achievement Badge | ERC-1155 | Có | Combo perks, Pro/Elite status | Blur, Rabbithole |
| Season Trophy | ERC-721 | Có | Giảm phí, airdrop bonus | Fortnite Pass, Hyperliquid |
| Referral NFT | ERC-5192 | Không (Soulbound) | % phí vĩnh viễn, early access | Blur, Hyperliquid ref |
| LP Position | ERC-721 | Có | Thị trường thứ cấp LP, collateral | Uniswap V3 LP NFT |
| Limit Order Receipt | ERC-721 | Có | OTC market cho limit orders | Không tiền lệ |
| Market Founder | ERC-721 | Có | 5–10% phí vĩnh viễn, dynamic art | Mirror, Azuro |
