...
Định nghĩa ABI (Application Binary Interface) cho mọi contract của PrediX. Địa chỉ contract xem tại [Tổng quan contracts](../contracts/overview.md).

## Diamond ABI (MarketFacet)

Các hàm chính để tương tác với market:
...
Chuẩn ERC-20 + ERC-2612 Permit cho outcome token và USDC:
...
// Dùng human-readable ABI (khuyến nghị)
...
- [Developer Quickstart](quickstart.md) — ví dụ hoàn chỉnh
- [Tổng quan contracts](../contracts/overview.md) — địa chỉ và kiến trúc
