...
An event with multiple choices: *"Who will win FIFA WC 2026?"* — each team is a child market, only one wins.
...
![Event multi-outcome: Event (FIFA WC) → N members (Argentina, Brazil, France...) → each member has YES+NO → resolve winningIndex → winner YES=$1](../_design/53-event-multi-outcome.svg)

## Example

Event: *"FIFA WC 2026 Winner"* with 48 teams.
