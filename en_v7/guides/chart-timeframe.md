...
![Chart data: 3 sources (Router.Trade canonical + Hook AMM analytics + CLOB matches) combined into YES price chart](../_design/41-chart-sources.svg)
...
In the event detail view, the chart shows the YES price of **all members** on the same timeline. For example, the event *"FIFA WC 2026 Winner"* over 6 months:
