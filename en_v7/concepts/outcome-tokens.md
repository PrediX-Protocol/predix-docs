...
![Outcome token $1 invariant: 100 USDC → Diamond mints 100 YES + 100 NO. Split/merge/redeem maintains YES.supply == NO.supply == totalCollateral at all times](../_design/40-outcome-tokens.svg)
...
Details: [Resolution](resolution.md), [Redeem & refund](../guides/redeem-and-claim.md).
