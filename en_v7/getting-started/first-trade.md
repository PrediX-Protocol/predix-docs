...
![First trade: connect wallet → bridge USDC → select market → buy YES/NO → receive outcome tokens](../_design/11-first-trade.svg)
...
Market: *"BTC above $100k before 2027-01-01?"*. Current YES price = $0.48.
