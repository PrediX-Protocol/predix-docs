...
### Why does YES + NO always equal ~$1? {#yes-no-1-dollar}
...
### Passkey vs crypto wallet — which one? {#passkey-vs-metamask}
...
### What if I lose the device with my passkey? {#lost-passkey}
...
### Can I deposit USDC from Binance / Coinbase? {#deposit-from-cex}

Yes. Many CEXs have added Unichain network — withdraw directly.

If your CEX doesn't support it yet: withdraw to Ethereum or Arbitrum, then use the [Bridge widget](bridge.md) in the app. Coinbase, Binance, OKX, and Bybit mostly support Unichain or chains with easy bridging.
...
Yes. Audit firm + public report available at [Security & timelock](../developers/security.md). There is also a bug bounty ranging from $100 to $500k depending on severity.
...
TBA. Follow [official Discord / Twitter](../resources/links.md) for announcements.
...
Discord, Twitter, Telegram — see [Links](../resources/links.md).
