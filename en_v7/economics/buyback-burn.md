...
![Buyback-burn: each week the protocol collects fees in USDC -> swap USDC to PRX (random timing, split txs) -> burn to 0x...dEaD -> supply reduced permanently](../_design/05-buyback-burn.svg)
