...
![Gauge flywheel loop: lock PRX -> vePRX -> vote gauge -> treasury LP subsidy -> LP earn more -> pool depth up -> trader happy -> volume up -> fee up -> yield up -> demand PRX -> lock more](../_design/58-gauge-flywheel.svg)
...
![Bribe market: project deposits bribe (PRX/USDC) -> vePRX holders vote gauge -> epoch end -> pool receives subsidy + voters receive bribe pro-rata](../_design/21-bribe-market.svg)
