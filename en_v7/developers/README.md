...
![4-layer stack: User -> FE (Next.js) -> BE (NestJS) -> Indexer (Ponder) -> Smart Contracts (Solidity, Unichain). One-way data flow, users sign txs directly with SC](../_design/03-architecture-4layer.svg)
